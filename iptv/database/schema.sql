...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    is_admin BOOLEAN NOT NULL DEFAULT 0, -- NOVO: 0 para user, 1 para admin
...
-- Criar tabela de conteúdo curado (Filmes e Séries ativas no catálogo)
CREATE TABLE IF NOT EXISTS catalogo_curado (
    id INT PRIMARY KEY AUTO_INCREMENT,
    tmdb_id INT NOT NULL UNIQUE,          -- ID único do filme ou série no TMDB
    media_type VARCHAR(10) NOT NULL,      -- 'movie' ou 'tv'
    titulo VARCHAR(255) NOT NULL,
    poster_path VARCHAR(255) NULL,        -- Salva o path do poster para evitar chamada TMDB na listagem
